...
cv2.imwrite("temp/result2.jpg", masked_img_inv)
cv2.waitKey(0)
cv2.destroyAllWindows()
...
cv2.imwrite("temp/vertical_bitwise_not.jpg", vertical)
cv2.waitKey(0)
cv2.destroyAllWindows()
...
cv2.imwrite("temp/dilated.jpg", dilated)
cv2.waitKey(0)
cv2.destroyAllWindows()
...
cv2.imwrite("temp/smooth.jpg", smooth)
cv2.waitKey(0)
cv2.destroyAllWindows()
